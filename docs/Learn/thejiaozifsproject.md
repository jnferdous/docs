JiaoZiFS provides version control over the data and uses Git-like semantics to create and access those versions. If you know git, you’ll be right at home with JiaoZiFS.
